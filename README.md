...
| :--- | :--- | :--- |
| **Primitive Types** | `i`, `b`, `f`, `str`, `char` | Integer, Boolean, Float, String, Char |
...
```rust
create i foo(type: parameter1, type: parameter2 ... type: parameter6) [
    // Function body logic
    let v: i, 1;
    out v;
]
